...
/**
 * Created by BaoChengcheng on 2017/9/5.
 */
...
public class Work {
    ...
    String promiseDate;
    String isAgent;
   // applySource;{"code":"01","title":"窗口接件"}
    //"state":{"code":"A","title":"有效"}
    String applyTime;
    String orgId;
    String orgName;
    String areaId;
    ...
    public String getApplicantCertTypeName() {
        return applicantCertTypeName;
    }

    public void setApplicantCertTypeName(String applicantCertTypeName) {
        this.applicantCertTypeName = applicantCertTypeName;
    }
